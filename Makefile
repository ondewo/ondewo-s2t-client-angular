...
IMAGE_UTILS_NAME=ondewo-s2t-client-utils-angular:${ONDEWO_S2T_VERSION}
PRETTIER_WRITE?=
...
release: ## Create Github and NPM Release
	...
	git add README.md
	git add RELEASE.md
	git add ondewo-s2t-client-angular.d.ts
	git add ondewo-s2t-client-angular.d.ts.map
