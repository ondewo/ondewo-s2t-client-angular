 ...
 */
class Quartznet {
    static { this.id = 'ondewo.s2t.Quartznet'; }
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
...
class QuartznetTriton {
    static { this.id = 'ondewo.s2t.QuartznetTriton'; }
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
 ...
 */
class Matchbox {
    static { this.id = 'ondewo.s2t.Matchbox'; }
    /**
     * Deserialize binary data to message
     * @param instance message instance
     */
...
class Speech2TextClient {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.2.6", ngImport: i0, type: Speech2TextClient, deps: [{ token: GRPC_SPEECH2_TEXT_CLIENT_SETTINGS, optional: true }, { token: GRPC_CLIENT_FACTORY }, { token: i1.GrpcHandler }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.2.6", ngImport: i0, type: Speech2TextClient, providedIn: 'any' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.2.6", ngImport: i0, type: Speech2TextClient, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'any' }]
